...
<div class="container">
  ...
  <div class="payment-group" id="paymentOptions">
    ...
    <button class="maya-btn" onclick="openQR('maya')">Maya</button>
  </div>

  <div class="contact-btn" onclick="openContact()">💬 Contact Support</div>

  <div class="footer">© 2026 BLADE'S
INTERNET SERVICES | Secure Access Portal</div>
</div>
...
<div id="qrModal" class="modal" onclick="closeAll()">
  <div class="modal-content" onclick="event.stopPropagation()">
    ...
    <img id="qrImage">
    <div>Pablito Jr A.</div>
    <div class="number-box" id="payNumber">0927-043-4806</div>
    ...
    <div class="payment-note">
      ...
      <br><br>Facebook: Senobga Xenohd
      <br>Phone: 0927-043-4806
    </div>
  </div>
</div>
